...
@push ('script')
    ...
    <script>
        $('#proyectourbanizacionTable').DataTable({
          ...
          ajax: '{!! route('getproyectosurbaniz') !!}',
          columns: [
              { data: 'id', name: 'id' },
              ...
              { data: 'categoriaurbanizacion.visado_sus', name: 'categoriaurbanizacion.visado_sus' },
              { data: 'categoriaurbanizacion.visado_bs', name: 'categoriaurbanizacion.visado_bs' },
          ...
          rowCallback:function(row,data) {
            ...
            if(data[9] != "")
            {
              $($(row).find("td")[10]).css("background-color","#F9D3D0");
            }
          }
        });
    </script>
