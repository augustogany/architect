@extends('layouts.app')
@section('title','Reporte: Proy. Urbs. por Rango de Fechas')
  ...
  <div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <form action="{{route('pu_por_rango_de_fechas_report')}}" method="POST">
              @csrf
                <div class="card" style="background-color: #8FBC8F">
                  <div class="card-header">
                    Proyectos Urbanozaciones por Rango de Fechas
                  </div>
