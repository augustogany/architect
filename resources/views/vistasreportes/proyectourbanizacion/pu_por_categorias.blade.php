  ...
  <div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <form action="{{route('pu_por_categorias_report')}}" method="POST">
              @csrf
                <div class="card" style="background-color: #8FBC8F">
                  <div class="card-header">
                      Proyectos Urbanozaciones por Categorías
                  </div>
                  <div class="card-body" style="background-color: #F0F8FF">
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <div class="form-line">
                            <select required name="categoriaurbanizacion_id" class="form-control form-control-sm select2">
                                @foreach ($categoriaurbanizacions as $categoriaurbanizacion)
                                  <option value="{{$categoriaurbanizacion->id}}">DE: {{$categoriaurbanizacion->mt2_inicio}} - A: {{$categoriaurbanizacion->mt2_fin}}</option>
                                @endforeach
                            </select>
                          </div>
