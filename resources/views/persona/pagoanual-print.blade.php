        ...
        <table style="width: 100%">
            <tr>
                ...
                <td style="text-align: right">
                    <h3 style="margin: 0px">RECIBO DE PAGO CENACAB</h3>
        ...
        <table border="1" style="width: 100%" cellpadding="3">
            ...
            <tbody>
                <tr>
                    <td>1</td>
                    <td>
                        Pago al CENACAB de la gestión {{ $pago->gestion->gestion }}
                    </td>
                    <td style="text-align: right">{{ number_format($pago->monto_pagado, 2, ',', '.') }}</td>
                </tr>
            </tbody>
            <tfoot>
                <tr>
                    <td colspan="2" style="text-align: right"><small>SUBTOTAL</small></td>
                    <td style="text-align: right; background-color:#ccc"><b>{{ number_format($pago->monto_pagado, 2, ',', '.') }}</b></td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: right"><small>DESC.</small></td>
                    <td style="text-align: right; background-color:#ccc"><b>{{ number_format($pago->monto_descuento, 2, ',', '.') }}</b></td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: right"><small>TOTAL</small></td>
                    <td style="text-align: right; background-color:#ccc"><b>{{ number_format($pago->monto_pagado - $pago->monto_descuento, 2, ',', '.') }}</b></td>
                </tr>
            </tfoot>
        </table>
    </div>
